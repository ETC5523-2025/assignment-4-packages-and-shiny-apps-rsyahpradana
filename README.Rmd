...
The **a4syahpradana** R package provides a simple and interactive way to explore the most common American names.  
It includes a cleaned dataset, a helper function for ranking names, and a Shiny dashboard to visualise the top-ranked results.
